...
ActiveRecord::Schema.define(version: 20140110211103) do
  ...
  add_index "spree_ink_buttons", ["uid"], name: "index_spree_ink_buttons_on_uid", unique: true
  add_index "spree_ink_buttons", ["variant_id"], name: "index_spree_ink_buttons_on_variant_id", unique: true
  ...
  add_index "spree_ink_deals", ["ink_button_id"], name: "index_spree_ink_deals_on_ink_button_id"
  add_index "spree_ink_deals", ["line_item_id"], name: "index_spree_ink_deals_on_line_item_id", unique: true
