...
ActiveRecord::Schema.define(version: 20141122162751) do
  ...
  create_table "spree_ink_buttons", force: true do |t|
  ...
  add_index "spree_ink_buttons", ["uid"], name: "index_spree_ink_buttons_on_uid", unique: true, using: :btree
  add_index "spree_ink_buttons", ["variant_id"], name: "index_spree_ink_buttons_on_variant_id", unique: true, using: :btree

  create_table "spree_ink_deals", force: true do |t|
    t.integer  "ink_button_id"
  ...
  add_index "spree_ink_deals", ["ink_button_id"], name: "index_spree_ink_deals_on_ink_button_id", using: :btree
  add_index "spree_ink_deals", ["promotion_id"], name: "index_spree_ink_deals_on_promotion_id", using: :btree
  add_index "spree_ink_deals", ["uid"], name: "index_spree_ink_deals_on_uid", unique: true, using: :btree
