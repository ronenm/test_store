...
ActiveRecord::Schema.define(version: 20140110211103) do
  ...
  add_index "spree_ink_deals", ["line_item_id"], name: "index_spree_ink_deals_on_line_item_id", unique: true, using: :btree
